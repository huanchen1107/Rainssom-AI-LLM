...
def load_rag_pipeline():
    ...
    contextualize_q_chain = contextualize_q_prompt | Ollama(model="llama3:8b", temperature=0.1) | StrOutputParser()
    ...
    qa_chain = qa_prompt | Ollama(model="llama3:8b", temperature=0.1) | StrOutputParser()
